import { JsonLine, JsonNode, RelationGraphInstance, RGCheckedItem, RGConnectingNode, RGCoordinate, RGCreatingLine, RGCreatingNode, RGEditingLine, RGEditingNodes, RGEventTargetType, RGFakeLine, RGLine, RGLineTarget, RGLink, RGNode, RGOptionsFull, RGPosition, RGSelectionView, RGUserEvent, RGViewInformation } from '../../../types';
...
export type RelationGraphEvents = {
    ...
    onLineVertexDropped: CustomEvent<[{
        newLineTemplate: JsonLine;
        fromNode: RGLineTarget | RGNode;
        toNode: RGLineTarget | RGNode;
    }]>;
    beforeCreateLine: CustomEvent<[{
        lineJson: JsonLine;
        fromNode: RGLineTarget | RGNode;
        toNode: RGLineTarget | RGNode;
    }]>;
    onLineBeCreated: CustomEvent<[{
        lineJson: JsonLine;
        fromNode: RGLineTarget | RGNode;
        toNode: RGLineTarget | RGNode;
    }]>;
...
export type RGEditingLineControllerEvents = {
    ...
    onMoveLineVertexEnd: {
        from: RGNode | RGLineTarget | RGPosition;
        to: RGNode | RGLineTarget | RGPosition;
...
export type RGSvelteHooksStore = {
    ...
    selectionStore: Readable<RGSelectionView & {
        show: boolean;
    }>;
